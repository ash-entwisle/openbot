...
function commandRegister(bot) {
    ...
    var rest = new discord_js_1.REST().setToken(Bun.env.DISCORD_TOKEN);
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, rest.put(discord_js_1.Routes.applicationCommands(Bun.env.DISCORD_ID), { body: commands })];
                case 1:
                    data = _a.sent();
                    console.log("Successfully reloaded ".concat(commands.length, " application (/) commands."));
                    return [3 /*break*/, 3];
                case 2:
                    error_1 = _a.sent();
